...
<div class="container col-8">
  ...
  <br/>
  <button type="submit" id="btnAddUser"  @click="submitUser" class="btn btn-primary ">Edit</button>
  </form>
</div>
...
export default {
  ...
  async registerForm() {
      ...
      console.log(id);
        await axios.post(`${this.apiUrl}/api/user/update/${id}`, this.formData).then((response) => {
